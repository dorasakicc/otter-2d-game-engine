...
namespace OTTER
{
    ...
    /// <summary>
    /// Sprite class represents a game character.
    /// </summary>
    public class Sprite
    {
        /// <summary>
        ...
        /// <summary>
        /// Current image (costume) of the sprite.
        /// </summary>
        ...
        /// <param name="posX">x sprite coordinate</param>
        /// <param name="posY">y sprite coordinate</param>
        ...
        /// <summary>
        /// Metoda koja moves the sprite in 4 basic directions: left, right, up and down.
        /// </summary>
        ...
        public void MoveLeft(int a, ref int k, out string s)
        {
            this.x -= a;
            k++;
            s = "Lijevo";
        }
        public void MoveUp(int a, ref int k, out string s)
        {
            this.y -= a;
            k++;
            s = "Gore";
        }
        public void MoveDown(int a, ref int k, out string s)
        {
            this.y += a;
            k++;
            s = "Dolje";
